        ...
        <Form id="contact-form">
          ...
          <Row className="mb-3">
            <Col sm={12} md={6} className="mb-3 mb-md-0">
              ...
              <Form.Select defaultValue="ILorin"> 
                <option>ILorin</option>
                <option>Offa</option>
                <option>Gbagba</option>
              </Form.Select>
            </Col>
            <Col sm={12} md={6}>
        ...
        <div className="container">
          ...
          <div className="row g-4">
            <div className="col-lg-4 d-flex flex-column align-items-center">
              ...
              <h3 className="text-center mt-3">Ilorin</h3>
            </div>
            <div className="col-lg-4 d-flex flex-column align-items-center">
              <img src={ManchesterLocationImg} className="img-fluid" alt="" />
              <h3 className="text-center mt-3">Offa</h3>
            </div>
            <div className="col-lg-4 d-flex flex-column align-items-center">
              <img src={LiverpoolLocationImg} className="img-fluid" alt="" />
              <h3 className="text-center mt-3">Gbagba</h3>
            </div>
          </div>
        </div>
      </div>
