      ...
      <div className="container">
        ...
        <div className="row g-4">
          <div className="col-lg-4">
            <Card className="d-flex align-items-center borde-0 h-100">
              <div className="mt-3">
                <svg
              ...
              <Card.Body>
                ...
                <Card.Text className="text-center">
                  ...
                  placeat alias suscipit, perferendis fugit sed similique
                  aliquid laboriosam nobis! Laudantium fuga amet sequi
                  molestiae. Quod ut illo ullam quibusdam.
                </Card.Text>
              </Card.Body>
            </Card>
          </div>
